...
from US_colon_experiment.tracking import tracking,define_tracking_region
from US_colon_experiment.freqency import plot_fft_plus_power
from US_colon_experiment.utilities import *
from US_colon_experiment.external.gaussian_BP.linefitting import LineFittingModel
...
#To download this model, you can find it here: https://mcmasteru365-my.sharepoint.com/:u:/g/personal/hussaa1_mcmaster_ca/EZZNi-wV_u9ElWTc7MYAPSMB1a9SEW7LbrMYYMA2onX52g?e=ME7OIg
simple_model = load_simple_unet_model('C:/Users/chenhuizingalab/Desktop/COLON_ANALYSIS_CODE/COLON_SEGMENTATION_2/colon_10kimages_model_best.hdf5')
...
def segmentation(img_bgr,method,args=0.9):
    ...
    if method == 'RF':
        ...
        # Replace 'your_image_path.jpg' with your image data
        #img_input = preprocess_frame(img_bgr)
...
#Parameters (EVERYTHING THAT NEEDS TO BE FILLED IN FOR CODE TO RUN)  
    video_path = r"C:\Users\chenhuizingalab\Desktop\COLON_ANALYSIS_CODE\ultrasound_videos\E33_CF\E33_ASC_Breath test.avi"
    map_type = 2            #1d: diameter map + freqency; 2d:2d color map
    #filename = r"C:\Users\chenhuizingalab\Desktop\E13_C5_DESC_5000_points.npz"  
...
#initialization
    #model_path = r"/Users/krishpatel/Desktop/RF_model.sav"
    method = "simple_model"
    ...
    analyzer = BinaryMaskAnalyser() # type: ignore
...
#collect data
    ...
    while(1):
        ...
        if ret:
            ...
            #gray_segmented_mask = cv2.cvtColor(mask_resized, cv2.COLOR_BGR2GRAY)
            ...
            #cv2.imshow('frame with edges', frame_with_edges_circles)
            ...
            #DEBUG_draw_sample(frame ,num_of_pts)
    ...
    filename = r'C:\Users\chenhuizingalab\Desktop\COLON_ANALYSIS_CODE\ultrasound_videos\E33_CF\E33_ASC_Breath test.npz'
    np.savez(filename, **data_to_save)
